...
import cars from "../../src/asset/auth-img.png";
...
export default function Login() {
    ...
    const fetchAPILogin = async () => {
        ...
        const response = await axios.post(`https://bootcamp-rent-cars.herokuapp.com/admin/auth/login`, data);
                ...
                <div class="row">
                    ...
                    <div className="col d-flex  align-items-center vh-100">
                        <Form onSubmit={onSubmitHandle}>
                            ...
                            {msg === "" ? null : (
                                <div className="pb-4">
                                    <Toast className={`${sts === "success" ? "bg-success" : sts === "error" ? "bg-danger" : null} text-white`}>
